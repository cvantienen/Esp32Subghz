...
float SubghzRadio::getFrequency() { return frequency; }
int SubghzRadio::getDataRate() { return dataRate; }
int SubghzRadio::getModulation() { return modulation; }
int SubghzRadio::getPacketFormat() { return pktFormat; }
SubghzRadio::Mode SubghzRadio::getMode() { return currentMode; }

// ---------------------------
// TRANSMIT SAMPLES
// ---------------------------
void SubghzRadio::transmit(const int16_t *samples, uint16_t samplesLength,
                           float mhz) {
    setFrequency(mhz);
