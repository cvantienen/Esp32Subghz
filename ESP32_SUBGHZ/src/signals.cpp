...
const int16_t samples_touchtunes_p1[] PROGMEM = {250, -250, 250, -750,
                                                 750, -250, 250, -250};

const int16_t samples_touchtunes_p2[] PROGMEM = {300, -300, 300, -800,
                                                 800, -300, 300, -300};

const int16_t samples_touchtunes_p3[] PROGMEM = {275, -275, 275, -725,
                                                 725, -275, 275, -275};

const int16_t samples_car_unlock[] PROGMEM = {400,  -1200, 400,
                                              -400, 1200,  -400};

const int16_t samples_car_lock[] PROGMEM = {400, -1200, 400, -400, 1200, -400};

const int16_t samples_car_trunk[] PROGMEM = {450, -1350, 450, -450, 1350, -450};

const int16_t samples_garage_door1[] PROGMEM = {350,  -1050, 350,
                                                -350, 1050,  -350};

const int16_t samples_garage_door2[] PROGMEM = {360,  -1080, 360,
                                                -360, 1080,  -360};
